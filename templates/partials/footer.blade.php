<footer class="site-footer">
  <div class="footer-inner">
    ...
    <div class="footer-logos">
      <img src="{{ get_template_directory_uri() }}/dist/images/WHA-logo.png" alt="World Habitat Awards" class="footer-logo footer-logo-wha" />
      <img src="{{ get_template_directory_uri() }}/dist/images/un-habitat-logo.png" alt="UN Habitat" class="footer-logo footer-logo-un" />
      <img src="{{ get_template_directory_uri() }}/dist/images/ESIF-logo.png" alt="European Structural and Investment Fund logo" class="footer-logo footer-logo-esif" />
    </div>
    ...
    <p class="footer-notice">Canopy Housing is a registered society under the Co-operative and Community Benefit Societies Act 2014. <br /> Regulated by the FCA, number 28665R, exempt charity status number XR21692.</p>
  </div>
</footer>
