...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_localize_script( 'sage/main.js', 'wp_vars', $translation_array );
...
add_action('after_setup_theme', function () {
    ...
    /**
     * Add page banner image size
     */
    add_image_size( 'page-banner', 1500, 500, true );
...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        'name'          => __('Donation gallery', 'sage'),
        'id'            => 'sidebar-donation-gallery',
        'before_widget' => '<section class="image-slider">',
        'after_widget'  => '</section>',
    ]);
    register_sidebar([
        'name'          => __('Footer', 'sage'),
